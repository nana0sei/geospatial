...
const wmsBaseUrl = " http://76ad2aba70b8.ngrok.io"; // "http://172.20.10.2"; // or http://localhost:8090";
...
export function useOpenLayers() {
  ...
  const layers = [
    ...
    new TileLayer({
      source: new TileWMS({
        url: `${wmsBaseUrl}/geoserver/geospatial/wms`,
        params: { LAYERS: "geospatial:countriesdbpedia", TILED: true },
